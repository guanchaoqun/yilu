...
class PHPUnit_TextUI_Command
{
     ...
     *     {
     *         // member-switch won't accept a value, it's an on/off
     *         $this->longOptions['member-switch'] = 'myHandler';
     *         // member-secondswitch will accept a value - note the equals sign
     *         $this->longOptions['member-secondswitch='] = 'myOtherHandler';
     *     }
     *
     *     // --member-switch  -> myHandler()
     *     protected function myHandler()
     *     {
     *     }
     *
     *     // --member-secondswitch foo -> myOtherHandler('foo')
