<?php
//namespace extend\aliyun\aip_demo;
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIebj76lu5g4oe"; // AccessKeyId

        $accessKeySecret = "MJP1dyUybwRFNtOqyQECdY3b0aYBEq"; // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("艺陆纵横");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_141606338");
...
//    }
     ...
     * @return stdClass
     */
    public static function querySendDetails($phone) {
