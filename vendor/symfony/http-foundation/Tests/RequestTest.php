...
class RequestTest extends TestCase
{
    ...
    public function getFormatToMimeTypeMapProvider()
    {
        return array(
            ...
            array('zepto', array('application/javascript', 'application/x-javascript', 'text/javascript')),
    ...
    public function testLegacyTrustedProxies()
    {
        ...
        $request->headers->set('X_MY_HOST', 'member.example.com');
        ...
        $this->assertEquals('member.example.com', $request->getHost());
